...
- Expenses (optional, encrypted enablement key). Tabs:
  ...
  - Forecast: 12 / 24 / all-time lookback. Set-aside beside the typical-month plan. Overlay is the irregular smear, not the Forecast column. Pin known futures; override category type. Vacation pot: savings sweep every month; tagged spend is a draw on the cash date; miss is below zero. Household allow-list vs vacation series vs excluded reimbursable. CAD and USD never added.
