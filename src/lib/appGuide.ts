...
- Expenses (optional, encrypted enablement key). Tabs:
  ...
  - Settings: Forecast lookback and irregular-outlier toggle; household allow-list vs vacation tags; erase expense data on this device. Not the chat API-key Settings.
